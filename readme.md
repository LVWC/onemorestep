...
## 1、所需技能
    ...
    一次配置，多国语言自动翻译，使得任意国家地区的人都能看懂、玩懂你做的mod
...
## 4、actorConfig表格字段说明
    ...
    name-zh：如果有这个字段，则玩家选择了中文时会使用这个名称。如果你希望使用俄语 则改为name-ru，或者，你可以复制一列数据出来，增加任何你希望的语言
...
## 7、技能说明
    ...
    单个技能的规则如下：
        ...
        2、技能：
            ...
            比较复杂的技能：   60003普通攻击后，有{s1}%的概率给敌人增加一个状态：
        ...
        everyNormalAttack,1:60002,35    每普通攻击1次触发一次，35%的概率对敌人进行物理攻击。
        上面这个例子，其实就是连击，你可以在skillDesc-zh中写成“增加35%的连击率”，来替换原有文案。他国语言会自动以原有文案进行翻译
        ...
        无论你对条件、技能、buff有什么疑问，或者是现有技能库中无法满足你的需求，请在qq群中联系作者添加新技能、条件、buff。
...
## 9、如何发布及更新
    ...
    备注：上传成功后，请不要去创意工坊订阅自己的mod，否则会造成修改文件时steam自动更新覆盖你本地最新的文件
